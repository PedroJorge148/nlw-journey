...
export function App() {
  ...
  function removeEmailFromInvites(emailToRemove: string) {
    const newEmailListWithRemovedOne = emailsToInvite.filter(email => email !== emailToRemove)

    setEmailsToInvite(newEmailListWithRemovedOne)
  }
          ...
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                type="text"
                placeholder="Quando?"
                className="bg-transparent text-lg placeholder-zinc-400 w-52 outline-none"
                disabled={isGuestsInputOpen}
              />
            </div>
            ...
            {isGuestsInputOpen ? (
              <button
                className="flex items-center gap-2 bg-zinc-800 text-zinc-200 rounded-lg px-5 py-2 font-medium hover:bg-zinc-7 00 transition"
              ...
              <button
                className="flex items-center gap-2 bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium hover:bg-lime-400 transition"
          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-semibold">Selecionar convidados</h2>
